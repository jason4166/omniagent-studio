...
def route_instruction(profile: AgentProfile, registry: ToolRegistry) -> str:
    ...
    return (
        "\nROUTING STAGE ONLY: choose an operation; do not answer or refuse the question here. "
        ...
        "is internal routing metadata and is never shown as the clarification. Do not invent "
