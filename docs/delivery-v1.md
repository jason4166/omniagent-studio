...
云端内部部署已经验收；截至 2026-09-21，域名 `omniagentstudio.top` 的 ICP 备案已通过（津ICP备2026013554号-1），公开 DNS/TLS 与外部监控仍未完成验收。当前不包含组织多租户、SSO、真实 CRM/邮件/支付写入、MFA 或邮件找回密码。更多边界见 [限制与改进](failures-and-limitations.md)。
